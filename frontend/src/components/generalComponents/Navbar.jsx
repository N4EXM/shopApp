...
const Navbar = ({isSignedIn}) => {
  ...
  return (
    <div className='fixed bottom-0 left-0 z-20 flex items-center justify-between w-full h-16 border-t-2 px-7 bg-secondaryBackground border-anti-flash-white/10 md:px-20 lg:px-32 lg:top-0 lg:border-b-2 lg:border-t-0'>
      ...
      <p className='w-full text-3xl font-bold lg:block sm:hidden'><span className='text-transparent bg-clip-text bg-gradient-to-tr from-caribbean-green to-frog'>Deal</span>Dash</p>


      <div className='flex flex-row items-center justify-start w-full border-2 rounded sm:hidden lg:flex border-anti-flash-white/30'>
        <input type="text" className='w-full p-1 pl-2 text-sm bg-transparent outline-none ' placeholder='Search an item...'/>
      ...
      <div className='flex flex-row items-center justify-between w-full h-full lg:justify-end lg:gap-3'>
        ...
        <button onClick={() => handleNavigate("")} className={`flex flex-col px-2 items-center justify-center ${location.pathname === '/' ? "border-b-2 lg:border-b-0 text-caribbean-green border-caribbean-green" : "text-anti-flash-white/80 dark:text-darkText"} h-full w-fit`}>
