  ...
  const Navbar = ({isSignedIn}) => {
    ...
    return (
      <div className='fixed bottom-0 left-0 z-20 flex items-center justify-between w-full h-16 border-t-2 px-7 bg-secondaryBackground border-anti-flash-white/10 md:px-20 lg:px-32 lg:top-0 lg:border-b-2 lg:border-t-0'>
        
        <p onClick={() => handleNavigate("")} className='w-full text-3xl font-bold cursor-pointer lg:block sm:hidden'><span className='text-transparent bg-clip-text bg-gradient-to-tr from-caribbean-green to-frog'>Deal</span>Dash</p>


        <div className='flex flex-row items-center justify-start w-full border rounded sm:hidden lg:flex border-anti-flash-white/30'>
          <input type="text" className='w-full p-1 pl-2 text-sm bg-transparent outline-none bg-rich-black ' placeholder='Search an item...'/>
          <button className='p-1 pl-1.5 duration-200 bg-mountain-meadow hover:bg-mint rounded-r-sm active:bg-bangladesh-green'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style={{fill:'currentcolor'}}><path d="M19.023 16.977a35.13 35.13 0 0 1-1.367-1.384c-.372-.378-.596-.653-.596-.653l-2.8-1.337A6.962 6.962 0 0 0 16 9c0-3.859-3.14-7-7-7S2 5.141 2 9s3.14 7 7 7c1.763 0 3.37-.66 4.603-1.739l1.337 2.8s.275.224.653.596c.387.363.896.854 1.384 1.367l1.358 1.392.604.646 2.121-2.121-.646-.604c-.379-.372-.885-.866-1.391-1.36zM9 14c-2.757 0-5-2.243-5-5s2.243-5 5-5 5 2.243 5 5-2.243 5-5 5z"></path></svg></button>
        </div>
    
        <div className='flex flex-row items-center justify-between w-full h-full lg:justify-end lg:gap-3'>

          <button onClick={() => handleNavigate("Notifications")} className={`flex flex-col px-2 items-center justify-center sm:hidden lg:flex ${location.pathname === '/Notifications' ? "border-b-2 lg:border-b-0 text-caribbean-green border-caribbean-green" : "text-anti-flash-white/80 dark:text-darkText"} h-full w-fit`}>
          ...
          <button onClick={() => handleNavigate("")} className={`lg:hidden flex flex-col px-2 items-center justify-center ${location.pathname === '/' ? "border-b-2 lg:border-b-0 text-caribbean-green border-caribbean-green" : "text-anti-flash-white/80 dark:text-darkText"} h-full w-fit`}>
          ...
          <button onClick={() => handleNavigate("Shop")} className={`flex flex-col px-2 items-center justify-center ${location.pathname === '/Shop' ? "border-b-2 lg:border-b-0 text-caribbean-green border-caribbean-green" : "text-anti-flash-white/80 dark:text-darkText"} h-full w-fit`}>
          ...
          <button onClick={() => handleNavigate("Discover")} className={`flex flex-col px-2 items-center justify-center ${location.pathname === '/Discover' ? "border-b-2 lg:border-b-0 text-caribbean-green border-caribbean-green" : "text-anti-flash-white/80 dark:text-darkText"} h-full w-fit`}>
          ...
          <button onClick={() => handleNavigate("Profile")} className={`lg:hidden flex flex-col px-2 items-center justify-center ${location.pathname === '/Profile' ? "border-b-2 lg:border-b-0 text-caribbean-green border-caribbean-green" : "text-anti-flash-white/80 dark:text-darkText"} h-full w-fit`}>
        ...
        {isProfileBtnActive && (
          isSignedIn ? 
            ...
            <div ref={dropdownRef} className='fixed flex flex-col gap-2 p-2 border rounded-md border-anti-flash-white/20 h-fit w-80 top-20 right-20 bg-secondaryBackground'>
              
              <button className='relative flex flex-row items-center justify-start w-full gap-5 p-2 font-semibold duration-100 hover:border-l-2 border-l-mountain-meadow '>
                ...
                Cart
                <span className='absolute w-6 h-auto p-1 text-xs font-semibold rounded-full right-3 bg-bangladesh-green'>1</span>
              </button>
              ...
              <div className='flex flex-col w-full gap-2'>
                <span className='w-full h-[1px] border border-anti-flash-white/30'></span>
                <button className='relative flex flex-row items-center justify-start w-full gap-5 p-2 font-semibold duration-100 hover:border-l-2 border-l-mountain-meadow '>
            ...
            :
            <div className='fixed flex flex-col gap-2 p-2 border rounded-md border-anti-flash-white/20 h-fit w-80 top-24 right-20 bg-secondaryBackground'>
