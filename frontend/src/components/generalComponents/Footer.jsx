...
const Footer = () => {
  return (
    ...
    <div className='flex flex-wrap items-center w-full h-full grid-cols-4 gap-5 text-sm sm:items-start lg:justify-between md:p-5 lg:px-32 lg:py-10 lg:grid bg-accent text-text bg-rich-black'>
