...
const CategorySection = ({categoryButtons, handleNavigate}) => {
  return (
    <div className='flex flex-col w-full h-full gap-4 px-5 lg:px-20 md:px-10 lg:gap-7'>
        ...
        <div className='grid items-center justify-between w-full h-full grid-cols-3 gap-3 p-3 border rounded lg:p-0 border-text/10 dark:border-darkText/10 lg:overflow-x-scroll scrollbar_hidden lg:border-none lg:grid lg:grid-cols-4 lg:grid-rows-2'>
