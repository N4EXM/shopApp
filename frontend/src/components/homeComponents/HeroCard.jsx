...
const HeroCard = ({category, title, content, cardImage, navigateFunction}) => {
  return (

    <div className='lg:p-24 lg:px-20 2xl:pt-28'>
      <div className={`flex flex-row items-center justify-start p-3 rounded-lg md:p-7 h-36 bg-gradient-to-tr from-primary to-tertiary dark:from-darkPrimary dark:to-darkTertiary md:h-80  lg:h-[30rem] lg:p-20 `}>
        ...
        <div className='flex flex-col items-start justify-start w-3/5 h-full text-darkText'>
            ...
            <button onClick={navigateFunction} className='p-2 px-4 text-xs font-medium rounded-sm md:text-base md:p-3 md:px-6 w-fit text-rich-black bg-background text-text lg:text-lg'>Buy Now</button>
        </div>
