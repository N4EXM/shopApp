...
const Home = () => {
  ...
  const [categoryButtons, setCategoryButtons] = useState([
    ...
    { 
      id: 3,
      name: 'Furniture',
      icon: <svg className='lg:size-8 md:size-6' xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" style={{fill:'currentColor'}}><path d="M19 13V4c0-1.103-.897-2-2-2H7c-1.103 0-2 .897-2 2v9a1 1 0 0 0-1 1v8h2v-5h12v5h2v-8a1 1 0 0 0-1-1zm-2-9v9h-2V4h2zm-4 0v9h-2V4h2zM7 4h2v9H7V4z"></path></svg>,
      link: ''
    },
    { 
      id: 4,
    ...
    { 
      id: 5,
      name: 'Laptop',
      icon: <svg className='lg:size-8 md:size-6' xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" style={{fill:'currentcolor'}}><path d="M20 17.722c.595-.347 1-.985 1-1.722V5c0-1.103-.897-2-2-2H5c-1.103 0-2 .897-2 2v11c0 .736.405 1.375 1 1.722V18H2v2h20v-2h-2v-.278zM5 16V5h14l.002 11H5z"></path></svg>,
      link: ''
    },
    { 
      id: 6,
  ...
  return (
    <div className='flex flex-col items-start justify-start w-full h-full min-h-screen'>
      ...
      <ScrollableProducts
        ...
        name={"Recommended"}
        icon={
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" style={{fill: 'currentcolor'}}><path d="M4 21h1V8H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2zM20 8h-7l1.122-3.368A2 2 0 0 0 12.225 2H12L7 7.438V21h11l3.912-8.596L22 12v-2a2 2 0 0 0-2-2z"></path></svg>
        }
      />
