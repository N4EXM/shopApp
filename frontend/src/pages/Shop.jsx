  ...
  return (
    <>
      <div className='relative flex flex-col items-start justify-start w-full h-full min-h-screen gap-2 pb-16 lg:hidden'>
        ...
        <button onClick={() => handleFilter(true)} className={`fixed p-3 rounded-full z-5 bg-primary dark:bg-darkPrimary text-darkText bottom-20 md:bottom-28 md:right-10 right-5 ${width < 1080 ? "block" : "hidden"}`}>
      ...
      <div className='flex-row items-start justify-start w-full h-screen min-h-full pt-16 sm:hidden lg:flex'>
        <div className='h-full w-80 bg-secondaryBackground dark:bg-darkSecondaryBackground'>
          hi
        </div>
      </div>
    </>
