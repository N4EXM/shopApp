...
const Shop = () => {
  ...
  return (
    <div className='relative flex flex-col items-start justify-start w-full h-full min-h-screen lg:pt-20'>
      ...
      {/* filter menu */}
      <div className={`fixed z-10 flex flex-col items-start justify-start w-full gap-5 p-5 border-t-[1px] bottom-16 bg-secondaryBackground transition duration-200 dark:bg-darkSecondaryBackground ${isFilterMenuActive ?  'translate-y-0': 'translate-y-80 '} border-text/10 dark:border-darkText/10`}>
        ...
        <div className='flex flex-col items-start justify-start w-full gap-2'>
          ...
          <div className='flex flex-col items-start justify-start w-full gap-2'>
            ...
            <div className='flex flex-row items-center justify-between w-full h-full gap-2 p-2 px-4 border rounded border-text/20 dark:border-darkText/20 bg-background'>
              <div className='flex flex-row items-center justify-start gap-2 '> 
                <input checked={isFiveStarActive} onChange={() => {setIsFiveStarActive(prev => !prev), console.log("five stars: ", isFiveStarActive)}} type="checkbox" className='bg-transparent border rounded-md size-5 border-text/60 accent-primary dark:accent-darkPrimary' />
            ...
            <div className='flex flex-row items-center justify-between w-full h-full gap-2 p-2 px-4 border rounded border-text/20 dark:border-darkText/20 bg-background'>
              <div className='flex flex-row items-center justify-start gap-2 '> 
                <input checked={isfourStarActive} onChange={() => {setIsfourStarActive(), console.log("fours stars: ", isfourStarActive)}} type="checkbox" className='bg-transparent border rounded-md size-5 border-text/60 accent-primary dark:accent-darkPrimary' />
                <p className='text-2xl text-amber-400'>★★★★</p>
              </div>
